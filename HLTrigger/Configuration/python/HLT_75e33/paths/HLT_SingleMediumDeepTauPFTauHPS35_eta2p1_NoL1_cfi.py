...
from ..modules.hltHpsSinglePFTau35MediumDitauWPDeepTauNoL1_cfi import *

HLT_SingleMediumDeepTauPFTauHPS35_eta2p1_NoL1 = cms.Path(
    HLTBeginSequence +
    ...
    hltHpsSinglePFTau35MediumDitauWPDeepTauNoL1 +
    HLTEndSequence
)