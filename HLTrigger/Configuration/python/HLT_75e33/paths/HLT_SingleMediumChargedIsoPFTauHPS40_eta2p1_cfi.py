...
from ..modules.hltHpsSinglePFTau40TrackPt1MediumChargedIsolation_cfi import *
from ..modules.hltL1SeedForSinglePuppiTau_cfi import *

HLT_SingleMediumChargedIsoPFTauHPS40_eta2p1 = cms.Path(
    HLTBeginSequence +
    hltL1SeedForSinglePuppiTau +
    hltL1P2GTCandTau +
    ...
    hltHpsSinglePFTau40TrackPt1MediumChargedIsolation +
    HLTEndSequence
)