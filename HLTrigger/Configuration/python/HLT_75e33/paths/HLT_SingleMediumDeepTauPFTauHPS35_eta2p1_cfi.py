...
from ..modules.hltHpsSinglePFTau35MediumDitauWPDeepTau_cfi import *
from ..modules.hltL1SeedForSinglePuppiTau_cfi import *

HLT_SingleMediumDeepTauPFTauHPS35_eta2p1 = cms.Path(
    HLTBeginSequence +
    ...
    hltHpsSinglePFTau35MediumDitauWPDeepTau +
    HLTEndSequence
)