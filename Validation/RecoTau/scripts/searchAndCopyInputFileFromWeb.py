...
def copyFiles(exe, filelist, identifier, identifier_folder, args):
        ...
        if os.path.isdir(outDir):
                print ("")
                input_str_outDir = input(outDir + " already exists. Do you want to delete it? ([n] y): ")
...
def main():
        ...
        #print curl_out
        curl_out_str = curl_out.decode('utf-8')
        output_list = curl_out_str.split("<tr><td><a href='")
        ...
        input_files_decision = input("Do you want to copy the above stated files to your local machine? (n [y]): ")
